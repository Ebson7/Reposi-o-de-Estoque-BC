          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2">
            ...
            {authRole === 'admin' && (
              <div className="flex items-center space-x-1.5">
                <span className="hidden md:inline-flex items-center space-x-1 px-2 py-1 rounded-lg text-xs font-bold bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                ...
                <button
                  ...
                  className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-rose-200 dark:border-rose-900/60 transition-colors cursor-pointer"
                >
            ...
            {authRole === 'vendor' && (
              <div className="flex items-center space-x-1.5">
                ...
                <button
                  onClick={onLogout}
                  title="Sair da conta"
                  className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-colors cursor-pointer"
                >
                  <LogOut className="w-3.5 h-3.5" />
